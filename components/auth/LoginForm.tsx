      ...
      <div className="w-full max-w-sm">
        ...
        <form
          ...
          onSubmit={(event) => {
            ...
            const result = admin ? signInAsAdmin(email, password, locale) : signIn(email, password, locale)
        ...
        >
          ...
          <button type="submit" className="mt-6 w-full rounded-xl bg-primary px-4 py-3 text-sm font-bold text-primary-foreground">
            {t('login')}
          </button>
        </form>
