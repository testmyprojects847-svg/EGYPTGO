...
function AdminDashboard() {
  const { dir } = useLanguage(); const { format } = useCurrency(); const [tab, setTab] = useState('tours'); const [sidebarOpen, setSidebarOpen] = useState(false); const stats = bookingService.stats()
